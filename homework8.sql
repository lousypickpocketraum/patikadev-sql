...
update employee
set name = 'Chester Bennington',
	email = 'chester@linkinpark.com'
where id = 42;

update employee
set name = 'Monkey D. Luffy',
	email = 'luffy@onepiece.me'
where id = 15;

update employee
set name = 'Levi Ackerman',
	email = 'levi@aot.org'
where id = 34;

update employee
set name = 'Osayi Samuel',
	email = 'os@qpr.com'
where id = 2;

update employee
set name = 'Leandro Trossard',
	email = 'trossard4@brighton.com'
where id = 13;
...
delete from employee where name = 'Jaquelyn Creffeild';

delete from employee where date = '1946-01-05';

delete from employee where email = 'jcreffeild17@dropbox.com';

delete from employee where name like 'Jaq%';
